...
class TestChatFunctions(unittest.TestCase):
    ...
    @patch('models.ticket_reasoning.nltk.word_tokenize')
    def test_get_response_book(self, mock_word_tokenize, mock_softmax, mock_max, mock_load, mock_tokenize, mock_bag_of_words, mock_NeuralNet, mock_TicketBot, mock_PredictionBot, mock_nlp, mock_MongoClient):
        # Mock MongoDB client
